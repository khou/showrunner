...
const gotTask3 = await call(worker, 'await_work', { member_id: regW.member_id })
...
const parked = await call(worker, 'await_work', { member_id: regW.member_id })
...
const search = await call(worker, 'search_notes', { member_id: regW.member_id, query: noteWord })
...
await call(worker, 'update_task', { member_id: regW.member_id, task_id: t3.task_id, status: 'completed', note: 'done' })
